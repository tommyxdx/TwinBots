...
钱包功能已实现地址发现、本地/只读适配器账本、扣费成本核算、综合排序与报告。**真实排名仍需完整钱包账本；公共池接口只发现地址。** 本版没有内置 Birdeye/Helius 原始数据转换器。详见 [排名口径](docs/WALLET_RANKING.md) 和 [钱包数据与 API 接入](docs/WALLET_DATA.md)。
